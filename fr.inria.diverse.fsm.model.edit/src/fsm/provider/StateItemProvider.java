	...
	protected void addFsmPropertyDescriptor(final Object object) {
		this.itemPropertyDescriptors.add
			(this.createItemPropertyDescriptor
				(((ComposeableAdapterFactory)this.adapterFactory).getRootAdapterFactory(),
				 this.getResourceLocator(),
				 this.getString("_UI_State_fsm_feature"),
				 this.getString("_UI_PropertyDescriptor_description", "_UI_State_fsm_feature", "_UI_State_type"),
				 FsmPackage.Literals.STATE__FSM,
				 true,
				 false,
				 true,
				 null,
