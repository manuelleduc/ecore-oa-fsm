...
public class FsmActionBarContributor
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(FsmEditorPlugin.INSTANCE.getString("_UI_FsmEditor_menu"), "fsmMenuID");
		...
		//
		this.createChildMenuManager = new MenuManager(FsmEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", this.createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		this.createSiblingMenuManager = new MenuManager(FsmEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
