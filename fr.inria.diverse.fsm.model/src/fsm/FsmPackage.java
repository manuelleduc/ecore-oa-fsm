...
public interface FsmPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INITIAL_STATE__NAME = FsmPackage.STATE__NAME;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE__FSM = FsmPackage.STATE__FSM;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE__OUTGOINGTRANSITIONS = FsmPackage.STATE__OUTGOINGTRANSITIONS;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE__INCOMMINGTRANSITIONS = FsmPackage.STATE__INCOMMINGTRANSITIONS;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE_FEATURE_COUNT = FsmPackage.STATE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE_OPERATION_COUNT = FsmPackage.STATE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FINAL_STATE__NAME = FsmPackage.STATE__NAME;
	 ...
	 * @ordered
	 */
	int FINAL_STATE__FSM = FsmPackage.STATE__FSM;
	 ...
	 * @ordered
	 */
	int FINAL_STATE__OUTGOINGTRANSITIONS = FsmPackage.STATE__OUTGOINGTRANSITIONS;
	 ...
	 * @ordered
	 */
	int FINAL_STATE__INCOMMINGTRANSITIONS = FsmPackage.STATE__INCOMMINGTRANSITIONS;
	 ...
	 * @ordered
	 */
	int FINAL_STATE_FEATURE_COUNT = FsmPackage.STATE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FINAL_STATE_OPERATION_COUNT = FsmPackage.STATE_OPERATION_COUNT + 0;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass FSM = FsmPackage.eINSTANCE.getFSM();
		 ...
		 * @generated
		 */
		EReference FSM__STATES = FsmPackage.eINSTANCE.getFSM_States();
		 ...
		 * @generated
		 */
		EReference FSM__TRANSITIONS = FsmPackage.eINSTANCE.getFSM_Transitions();
		 ...
		 * @generated
		 */
		EReference FSM__INITIALSTATE = FsmPackage.eINSTANCE.getFSM_Initialstate();
		 ...
		 * @generated
		 */
		EAttribute FSM__NAME = FsmPackage.eINSTANCE.getFSM_Name();
		 ...
		 * @generated
		 */
		EClass INITIAL_STATE = FsmPackage.eINSTANCE.getInitialState();
		 ...
		 * @generated
		 */
		EClass STATE = FsmPackage.eINSTANCE.getState();
		 ...
		 * @generated
		 */
		EAttribute STATE__NAME = FsmPackage.eINSTANCE.getState_Name();
		 ...
		 * @generated
		 */
		EReference STATE__FSM = FsmPackage.eINSTANCE.getState_Fsm();
		 ...
		 * @generated
		 */
		EReference STATE__OUTGOINGTRANSITIONS = FsmPackage.eINSTANCE.getState_Outgoingtransitions();
		 ...
		 * @generated
		 */
		EReference STATE__INCOMMINGTRANSITIONS = FsmPackage.eINSTANCE.getState_Incommingtransitions();
		 ...
		 * @generated
		 */
		EClass FINAL_STATE = FsmPackage.eINSTANCE.getFinalState();
		 ...
		 * @generated
		 */
		EClass TRANSITION = FsmPackage.eINSTANCE.getTransition();
		 ...
		 * @generated
		 */
		EReference TRANSITION__FSM = FsmPackage.eINSTANCE.getTransition_Fsm();
		 ...
		 * @generated
		 */
		EReference TRANSITION__FROM = FsmPackage.eINSTANCE.getTransition_From();
		 ...
		 * @generated
		 */
		EReference TRANSITION__TO = FsmPackage.eINSTANCE.getTransition_To();
		 ...
		 * @generated
		 */
		EAttribute TRANSITION__EVENT = FsmPackage.eINSTANCE.getTransition_Event();
