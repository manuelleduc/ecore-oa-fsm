...
public class FsmAdapterFactory extends AdapterFactoryImpl {
	...
	public FsmAdapterFactory() {
		if (FsmAdapterFactory.modelPackage == null) {
			FsmAdapterFactory.modelPackage = FsmPackage.eINSTANCE;
		}
	}
	...
	public boolean isFactoryForType(final Object object) {
		if (object == FsmAdapterFactory.modelPackage) {
			return true;
		}
		if (object instanceof EObject) {
			return ((EObject)object).eClass().getEPackage() == FsmAdapterFactory.modelPackage;
		}
		return false;
	}
	...
	protected FsmSwitch<Adapter> modelSwitch =
		new FsmSwitch<Adapter>() {
			@Override
			public Adapter caseFSM(final FSM object) {
				return FsmAdapterFactory.this.createFSMAdapter();
			}
			@Override
			public Adapter caseInitialState(final InitialState object) {
				return FsmAdapterFactory.this.createInitialStateAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseFinalState(final FinalState object) {
				return FsmAdapterFactory.this.createFinalStateAdapter();
			}
			@Override
