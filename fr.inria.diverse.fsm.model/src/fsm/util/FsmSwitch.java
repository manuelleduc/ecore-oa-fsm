...
public class FsmSwitch<T> extends Switch<T> {
	 ...
	 */
	public FsmSwitch() {
		if (FsmSwitch.modelPackage == null) {
			FsmSwitch.modelPackage = FsmPackage.eINSTANCE;
		}
	}
	...
	protected boolean isSwitchFor(final EPackage ePackage) {
		return ePackage == FsmSwitch.modelPackage;
	}
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		switch (classifierID) {
			case FsmPackage.FSM: {
				final FSM fsm = (FSM)theEObject;
				T result = this.caseFSM(fsm);
				if (result == null) {
			...
			case FsmPackage.INITIAL_STATE: {
				final InitialState initialState = (InitialState)theEObject;
				T result = this.caseInitialState(initialState);
				if (result == null) {
					result = this.caseState(initialState);
				}
				if (result == null) {
					result = this.defaultCase(theEObject);
				}
			...
			case FsmPackage.FINAL_STATE: {
				final FinalState finalState = (FinalState)theEObject;
				T result = this.caseFinalState(finalState);
				if (result == null) {
					result = this.caseState(finalState);
				}
				if (result == null) {
					result = this.defaultCase(theEObject);
				}
	 ...
	 * @generated
	 */
	public T caseFSM(final FSM object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseInitialState(final InitialState object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFinalState(final FinalState object) {
		return null;
	}
