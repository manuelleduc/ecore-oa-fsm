...
/**
 * This is the item provider adapter for a {@link gfsm.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GfsmPackage.Literals.STATE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GfsmPackage.Literals.STATE__FSM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GfsmPackage.Literals.STATE__OUTGOINGTRANSITIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GfsmPackage.Literals.STATE__INCOMMINGTRANSITIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GfsmPackage.Literals.STATE__IN_EXPRESSION);
			childrenFeatures.add(GfsmPackage.Literals.STATE__OUT_EXPRESSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GfsmPackage.Literals.STATE__IN_EXPRESSION,
				 GfsmFactory.eINSTANCE.createIntVarAssign()));

		newChildDescriptors.add
			(createChildParameter
				(GfsmPackage.Literals.STATE__IN_EXPRESSION,
				 GfsmFactory.eINSTANCE.createIntBlock()));

		newChildDescriptors.add
			(createChildParameter
				(GfsmPackage.Literals.STATE__OUT_EXPRESSION,
				 GfsmFactory.eINSTANCE.createIntVarAssign()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == GfsmPackage.Literals.STATE__IN_EXPRESSION ||
			childFeature == GfsmPackage.Literals.STATE__OUT_EXPRESSION;
