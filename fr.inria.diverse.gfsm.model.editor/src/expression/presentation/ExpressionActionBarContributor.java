...
public class ExpressionActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(GfsmEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			...
			public void run() {
				try {
					ExpressionActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
				}
	...
	protected IAction refreshViewerAction =
		new Action(GfsmEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			...
			public boolean isEnabled() {
				return ExpressionActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
			}

			@Override
			public void run() {
				if (ExpressionActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
					final Viewer viewer = ((IViewerProvider)ExpressionActionBarContributor.this.activeEditorPart).getViewer();
					if (viewer != null) {
						viewer.refresh();
					}
				}
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_ExpressionEditor_menu"), "expressionMenuID");
