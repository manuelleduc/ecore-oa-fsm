...
/**
 * This is the action bar contributor for the Gfsm model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GfsmActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(GfsmEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
					GfsmActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
				}
	...
	protected IAction refreshViewerAction =
		new Action(GfsmEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
			public boolean isEnabled() {
				return GfsmActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
			}

			@Override
			public void run() {
				if (GfsmActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
					final Viewer viewer = ((IViewerProvider)GfsmActionBarContributor.this.activeEditorPart).getViewer();
					if (viewer != null) {
						viewer.refresh();
					}
				}
	 ...
	 * @generated
	 */
	public GfsmActionBarContributor() {
	...
	public void contributeToToolBar(final IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("gfsm-settings"));
		toolBarManager.add(new Separator("gfsm-additions"));
	}
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_GfsmEditor_menu"), "gfsmMenuID");
		...
		//
		this.createChildMenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", this.createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		this.createSiblingMenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(final IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		this.populateManager(submenuManager, this.createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(GfsmEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
