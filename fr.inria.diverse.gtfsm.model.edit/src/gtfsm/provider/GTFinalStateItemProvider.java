...
import gfsm.provider.GFinalStateItemProvider;
...
/**
 * This is the item provider adapter for a {@link gtfsm.GTFinalState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GTFinalStateItemProvider extends GFinalStateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GTFinalStateItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.TIMED_STATE__STATEGUARD);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GTFinalState"));
	}
	...
	public String getText(Object object) {
		String label = ((GTFinalState)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GTFinalState_type") :
			getString("_UI_GTFinalState_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GTFinalState.class)) {
