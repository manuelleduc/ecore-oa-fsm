...
import gfsm.provider.GStateItemProvider;
...
/**
 * This is the item provider adapter for a {@link gtfsm.GTState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GTStateItemProvider extends GStateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GTStateItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GTState"));
	}
	...
	public String getText(Object object) {
		String label = ((GTState)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GTState_type") :
			getString("_UI_GTState_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GTState.class)) {
