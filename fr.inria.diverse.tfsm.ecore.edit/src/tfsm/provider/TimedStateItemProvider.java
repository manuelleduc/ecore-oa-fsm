...
/**
 * This is the item provider adapter for a {@link tfsm.TimedState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimedStateItemProvider extends StateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TimedStateItemProvider(final AdapterFactory adapterFactory) {
	...
	public Object getImage(final Object object) {
		return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/TimedState"));
	}
	...
	public String getText(final Object object) {
		final String label = ((TimedState)object).getName();
		return label == null || label.length() == 0 ?
			this.getString("_UI_TimedState_type") :
			this.getString("_UI_TimedState_type") + " " + label;
	}
	...
	public void notifyChanged(final Notification notification) {
		...
		switch (notification.getFeatureID(TimedState.class)) {
