...
/**
 * This is the item provider adapter for a {@link tfsm.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__EVENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TfsmPackage.Literals.TRANSITION__TO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TfsmPackage.Literals.TRANSITION__CLOCKRESETS);
			childrenFeatures.add(TfsmPackage.Literals.TRANSITION__TRANSITIONGUARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__CLOCKRESETS,
				 TfsmFactory.eINSTANCE.createClockReset()));

		newChildDescriptors.add
			(createChildParameter
				(TfsmPackage.Literals.TRANSITION__TRANSITIONGUARD,
