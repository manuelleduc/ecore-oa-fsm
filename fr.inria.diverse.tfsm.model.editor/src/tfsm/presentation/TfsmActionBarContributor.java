...
public class TfsmActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(TfsmEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			...
			public void run() {
				try {
					TfsmActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
				}
	...
	protected IAction refreshViewerAction =
		new Action(TfsmEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			...
			public boolean isEnabled() {
				return TfsmActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
			}

			@Override
			public void run() {
				if (TfsmActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
					final Viewer viewer = ((IViewerProvider)TfsmActionBarContributor.this.activeEditorPart).getViewer();
					if (viewer != null) {
						viewer.refresh();
					}
				}
	...
	public void contributeToMenu(final IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(TfsmEditorPlugin.INSTANCE.getString("_UI_TfsmEditor_menu"), "tfsmMenuID");
		...
		//
		this.createChildMenuManager = new MenuManager(TfsmEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", this.createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		this.createSiblingMenuManager = new MenuManager(TfsmEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
